...
export const newTreeArray:
    ...
    (
        ...
        try {
            ...
            const childrenKey = has(treeItemMap,"children")?treeItemMap.children:"children";
            ...
            forEach(treeList, e => {
                ...
                if (has(item, "children") && (!item.children || item.children.length === 0)) delete item.children;
                arr.push(item);
            });
            return arr;
        } catch (error) {
